...
set programmers {
    { hw_server "localhost:3121" target "xilinx_tcf/Digilent/" id "210249B06E36" device "xcku035" }
    { hw_server "localhost:3121" target "xilinx_tcf/Digilent/" id "210249B07138" device "xcku035" }
}
